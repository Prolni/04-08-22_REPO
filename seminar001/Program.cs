...
int num1 = int.Parse(Console.ReadLine()); //преобразование  введенного числа в ЦИФРОВОЕ ЗНАЧЕНИЕ ЧИСЛА через int.Parse()
Console.WriteLine("Введите второе число: ");
int num2 = Convert.ToInt32(Console.ReadLine()); //преобразование  введенного числа в ЦИФРОВОЕ ЗНАЧЕНИЕ ЧИСЛА через Convert.ToInt32()
